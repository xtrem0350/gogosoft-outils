    ...
    <nav className="space-y-1" aria-label="Navigation principale">
      {navigation.map(({ label, to, icon: Icon }) => (
        <Link
          ...
          className={cn(
            "flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-sidebar-foreground/65 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
            pathname === to && "bg-sidebar-accent text-sidebar-accent-foreground shadow-sm",
          )}
        >
